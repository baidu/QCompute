...
"""
There are three simple cases of using the QPU and modules.
...
# case 3:
# The case below demonstrating what will happen when we close ServerModule.Mapping Module
# by setting the disable parameter true.
# H(q[0])
# CH(q[0], q[1])
# CH(q[0], q[2])
# env.serverModule(ServerModule.Mapping, {"disable": True})

# Measure with the computational basis
MeasureZ(*env.Q.toListPair())

# Generates circuit definition in Protobuf format and print
env.publish()
print(env.program)

# Commit the quest with 4000 shots to the cloud
