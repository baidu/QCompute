...
r"""
An example of linearly entangled circuit.
"""
...
cir = Circuit("Linearly entangled circuit")
...
for i in range(0, qubit_num):
    for j in range(max(i - layer_num, 0), qubit_num):
        b_theory[i][j] += 1
...
for i in range(0, qubit_num - layer_num - 1):
    for j in range(i + layer_num + 1, qubit_num):
        c_theory[i][j] += 1
