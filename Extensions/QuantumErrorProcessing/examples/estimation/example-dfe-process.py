...
"""
An example to demonstrate the Direct Fidelity Estimation protocol on the CX gate.
"""
import time
import QCompute
...
# Step 1. Set the quantum program for the CX gate.
...
# QCompute.Define.hubToken = "jjDhIWmNTT6cA+BvB7htIg=="
...
# check how well the CX gate is implemented in the QuantumComputer.
...
print('Fidelity of the CX gate on qubits {} is: F = {:.5f}'.format(qubits, dfe.fidelity))
