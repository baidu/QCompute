...
if __name__ == "__main__":
    ...
    count_list = [
        ...
        new_val_noisy,
        new_val_corr_lsc,
        new_val_corr_lsc_tensor,
        new_val_corr_inv,
        new_val_corr_inv_tensor,
        new_val_corr_ibu,
        new_val_corr_ibu_tensor,
        new_val_corr_neu,
        new_val_corr_neu_tensor,
    ]
    legend = [
        "val ideal simulator",
        "val noisy",
        "val corr noisy LSC",
        "val corr noisy LSC tensor",
        "val corr noisy INV",
        "val corr noisy INV tensor",
        "val corr noisy IBU",
        "val corr noisy IBU tensor",
        "val corr noisy Neumann",
