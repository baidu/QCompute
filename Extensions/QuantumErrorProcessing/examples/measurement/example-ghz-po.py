...
def corrected_parity_oscillation(
...
if __name__ == "__main__":
    ...
    if VISUALIZE_EXPECTATION_VALUES:
        ...
        plt.savefig("GHZ_PO_N={}.png".format(n), format="png", dpi=600, bbox_inches="tight", pad_inches=0.1)
    ...
    if VISUALIZE_EUCLIDEAN_DISTANCES:
        ...
        plt.scatter(
            x_range,
            [noisy_euc_list[i] for i in indices],
            marker=markers["hardware"],
            color=colors["hardware"],
            edgecolors="none",
            alpha=0.75,
        ...
        plt.scatter(
            x_range,
            [noisy_val_diff_list[i] for i in indices],
            marker=markers["hardware"],
            color=cm(1.0 * 5 / NUM_COLORS),
            edgecolors="none",
            alpha=0.75,
        ...
        plt.scatter(
            x_range,
            [inv_euc_list[i] for i in indices],
            marker=markers["inverse"],
            color=colors["inverse"],
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [inv_val_diff_list[i] for i in indices],
            marker=markers["inverse"],
            color=cm(1.0 * 6 / NUM_COLORS),
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [ls_euc_list[i] for i in indices],
            marker=markers["least square"],
            color=colors["least square"],
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [ls_val_diff_list[i] for i in indices],
            marker=markers["least square"],
            color=cm(1.0 * 7 / NUM_COLORS),
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [ibu_euc_list[i] for i in indices],
            marker=markers["ibu"],
            color=colors["ibu"],
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [ibu_val_diff_list[i] for i in indices],
            marker=markers["ibu"],
            color=cm(1.0 * 8 / NUM_COLORS),
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [neu_euc_list[i] for i in indices],
            marker=markers["neu"],
            color=colors["neu"],
            edgecolors="none",
            alpha=1,
        ...
        plt.scatter(
            x_range,
            [neu_val_diff_list[i] for i in indices],
            marker=markers["neu"],
            color=cm(1.0 * 9 / NUM_COLORS),
            edgecolors="none",
            alpha=1,
        ...
        plt.savefig("GHZ_PO2_N={}.png".format(n), format="png", dpi=600, bbox_inches="tight", pad_inches=0.1)
